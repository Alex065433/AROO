...
export const PACKAGES = [
  { id: 'activation', name: 'ID Activation', price: 50, nodes: 1, weeklyEarning: 0, features: ['5% Direct Referral Yield', '10% Matching Dividend', 'Weekly ROI Yield', 'Node Security Protocol'] },
  { id: 'starter', name: 'Starter Node', price: 150, nodes: 3, weeklyEarning: 4, features: ['5% Direct Referral Yield', '10% Matching Dividend', 'Weekly ROI Yield', 'Node Security Protocol'] },
  { id: 'bronze', name: 'Bronze Node', price: 350, nodes: 7, weeklyEarning: 12, features: ['5% Direct Referral Yield', '10% Matching Dividend', 'Weekly ROI Yield', 'Node Security Protocol'] },
  { id: 'silver', name: 'Silver Node', price: 750, nodes: 15, weeklyEarning: 30, features: ['5% Direct Referral Yield', '10% Matching Dividend', 'Weekly ROI Yield', 'Node Security Protocol'] },
  { id: 'gold', name: 'Gold Node', price: 1550, nodes: 31, weeklyEarning: 70, features: ['5% Direct Referral Yield', '10% Matching Dividend', 'Weekly ROI Yield', 'Node Security Protocol'] },
  { id: 'platinum', name: 'Platinum Node', price: 3150, nodes: 63, weeklyEarning: 156, features: ['5% Direct Referral Yield', '10% Matching Dividend', 'Weekly ROI Yield', 'Node Security Protocol'] },
  { id: 'diamond', name: 'Diamond Node', price: 6350, nodes: 127, weeklyEarning: 343, features: ['5% Direct Referral Yield', '10% Matching Dividend', 'Weekly ROI Yield', 'Node Security Protocol'] },
  { id: 'ambassador', name: 'Ambassador Node', price: 12750, nodes: 255, weeklyEarning: 700, features: ['5% Direct Referral Yield', '10% Matching Dividend', 'Weekly ROI Yield', 'Node Security Protocol'] },
];
